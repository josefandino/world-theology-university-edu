...
@Component({
  selector: 'app-en-bachelor-of-clinical-psychology',
  imports: [AngularModule, MaterialModule, BannerComponent],
  templateUrl: './en-bachelor-of-clinical-psychology.component.html',
  styles: ``,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EnBachelorOfClinicalPsychologyComponent {
