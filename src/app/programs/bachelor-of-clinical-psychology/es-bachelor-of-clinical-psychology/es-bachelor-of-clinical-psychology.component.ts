...
@Component({
  selector: 'app-es-bachelor-of-clinical-psychology',
  imports: [AngularModule, MaterialModule, BannerComponent],
  templateUrl: './es-bachelor-of-clinical-psychology.component.html',
  styles: ``,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EsBachelorOfClinicalPsychologyComponent {
