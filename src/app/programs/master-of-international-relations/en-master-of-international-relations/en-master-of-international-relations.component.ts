...
@Component({
  selector: 'app-en-master-of-international-relations',
  imports: [AngularModule, MaterialModule, BannerComponent],
  templateUrl: './en-master-of-international-relations.component.html',
  styles: ``,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EnMasterOfInternationalRelationsComponent {
