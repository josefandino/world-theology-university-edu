...
@Component({
  selector: 'app-en-master-of-clinical-psychology',
  imports: [AngularModule, MaterialModule, BannerComponent],
  templateUrl: './en-master-of-clinical-psychology.component.html',
  styles: ``,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EnMasterOfClinicalPsychologyComponent {
