...
@Component({
  selector: 'app-en-bachelor-of-international-relations',
  imports: [AngularModule, MaterialModule, BannerComponent],
  templateUrl: './en-bachelor-of-international-relations.component.html',
  styles: ``,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EnBachelorOfInternationalRelationsComponent {
