...
@Component({
  selector: 'app-es-bachelor-of-international-relations',
  imports: [AngularModule, MaterialModule, BannerComponent],
  templateUrl: './es-bachelor-of-international-relations.component.html',
  styles: ``,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EsBachelorOfInternationalRelationsComponent {
